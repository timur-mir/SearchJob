package home.howework.searchjob.data.mocknetwork

import android.content.Context
import com.google.gson.Gson
import com.google.gson.reflect.TypeToken
import home.howework.searchjob.App
...
class MockRemoteDateSource {
    val context = App.context
    lateinit var gson: Gson
    private val gson2: Gson by lazy { Gson() }
    lateinit var mainSource:OffersWorkCompaniesDto
    ...
    private fun getJsonDataFromAsset(): String {
        var jsonString: String = "{\n" +
                ...
                "\n"
//        try {
//            jsonString = App.context?.assets?.open("serverdata.txt")?.bufferedReader()
//                .use { it?.readText() ?: "wsbsjhdjfsfhsdfdsfsddf" }
...
//        }
    ...
    private fun getOffersWorkCompanies(): OffersWorkCompaniesDto {
        val jsonFileString = getJsonDataFromAsset()
        val offersWorkCompaniesType = object : TypeToken<OffersWorkCompaniesDto>() {}.type
        mainSource = gson2.fromJson(jsonFileString, offersWorkCompaniesType) as OffersWorkCompaniesDto
        return mainSource
    }

    fun getOffers(): ArrayList<OffersDto> {
        val listOffersWorkCompanies = getOffersWorkCompanies()
        return listOffersWorkCompanies.offers
    }
    fun getVacancies(): ArrayList<VacanciesDto> {
        val listOffersWorkCompanies = getOffersWorkCompanies()
        return listOffersWorkCompanies.vacancies
    }
