...
import home.howework.searchjob.presentation.main.LoginFragment.Help.flagBackground
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.nextAction.setOnClickListener {
                if (Patterns.EMAIL_ADDRESS.matcher(binding.editField.text.toString())
                    ...
                    val action = LoginFragmentDirections.actionLoginFragmentToConfirmationFragment(binding.editField.text.toString())
